...
const deployFn: DeployFunction = async (hre) => {
  ...
  await doStep({
    ...
    step: 5,
    message: `
      Step 5 will initialize all Bedrock contracts After this step is executed, users will be able
      to deposit and withdraw assets via the OptimismPortal or via the L1CrossDomainMessenger.
